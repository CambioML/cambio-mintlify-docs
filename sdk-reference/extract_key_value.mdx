...
<CardGroup cols={2}>
  <Card
    title="AnyParser Sync Extract Key Value Example"
    icon="bolt-lightning"
    href="https://github.com/CambioML/any-parser/blob/main/examples/extract_key_value_pdf.ipynb"
  >
    Extracting key-values from a fake W2 document.
  </Card>
  <Card
    title="AnyParser Async Extract Key Value Example"
    icon="rotate"
    href="https://github.com/CambioML/any-parser/blob/main/examples/async_extract_key_value_pdf.ipynb"
  >
    Extracting key-values from a fake W2 document.
  </Card>
</CardGroup>
